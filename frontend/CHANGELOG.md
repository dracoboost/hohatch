...
- Upgraded `next` to version `15.4.8` to address the critical RCE vulnerability CVE-2025-55182.
...
[1.2.4]: <https://github.com/dracoboost/hohatch/compare/v1.2.3...v1.2.4>
