...
describe("MarkdownRenderer", () => {
  it("renders markdown content correctly", () => {
    ...
    render(<Lightbox><MarkdownRenderer markdownContent={markdown} /></Lightbox>);
  ...
  it("renders images and opens lightbox on click", () => {
    ...
    expect(screen.getByAltText("Lightbox view")).toHaveAttribute("src", expect.stringContaining("/images/test.png"));
  });
});
